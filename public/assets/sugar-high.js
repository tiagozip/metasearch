...
function tokenize(e, t) {
  const { keywords: n, onCommentStart: i, onCommentEnd: s } = { ...DefaultOptions, ...t };
  let r = "",
    o = -1,
    c = [-1, ""],
    a = [-2, ""];
  ...
  for (let t = 0; t < e.length; t++) {
    ...
    if (isSingleQuotes(n) && !h() && !E()) {
      (C(), "\\" !== o && (g && n === g ? (g = null) : g || (g = n)), C(T_STRING, n));
      continue;
    }
    ...
    if (l) {
      if (!T && "<" === n) {
        (C(), "/" === a ? ((T = 2), (r = _), t++) : ((T = 1), (r = n)), C(T_SIGN));
        continue;
      }
      if (T) {
        if (">" === n && !"/=".includes(o)) {
    ...
    if (N || y || isSingleQuotes(g)) r += n;
      ...
      ((m = !1), o !== t && l ? ((r = e.slice(o, t + 1)), C(T_STRING)) : ((r = n), C(), (t = o)));
    } else if (i(n, a)) {
      C();
      const o = t,
        c = i(n, a);
        ...
        : f && "}" === n
          ...
          : (G && !JSXBrackets.has(n)) ||
            ...
            : ("</" === u && (r = u),
              C(),
              "</" !== u && (r = n),
              "</" === _ || "/>" === _ ? ((r = _), C(), t++) : JSXBrackets.has(n) && C());
  }
  return (C(), u);
}
function generate(e) {
